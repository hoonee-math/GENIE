...
import InsertPassage from "@/views/generation/question/InsertPassage.vue";
import InsertPassageMobile from "@/views/generation/question/InsertPassageMobile.vue";
