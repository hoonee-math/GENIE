    ...
    <div class="flex flex-col items-start gap-4 w-full h-full md:mt-0 bg-white md:bg-[#f9fafb] dev-border">
        ...
        <div class="flex flex-col w-full h-full min-h-[500px] border border-gray-300 bg-white rounded-2xl">
            ...
            <div class="flex flex-col md:flex-row w-full h-full ">
                <!-- 왼쪽 영역 (편집 도구, 지문 출력) -->
                <div class="min-w-0 m-7 dev-border" :class="[`flex-[${leftRatio}]`,$slots.right?'md:mr-0':'']">
                ...
                <!-- 가운데 구분선 -->
                <div v-if="$slots.right" class="h-px bg-gray-300 mx-6 my-6 md:w-px md:h-auto md:bg-gray-300 md:mx-7 md:my-7"></div>

                <!-- 오른쪽 영역 (지문 분석) -->
                <div v-if="$slots.right" class="min-w-0 max-h-[100vh] m-7 dev-border overflow-hidden" :class="[`flex-[${rightRatio}]`,$slots.right?'md:ml-0':'']">
