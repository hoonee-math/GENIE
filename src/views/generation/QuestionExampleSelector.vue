                    ...
                    <div
                        ...
                        <div class="flex justify-between w-full mb-6 md:mb-8">
                            ...
                            <div v-if="selectedQuestion"
                                class="px-2 py-1 rounded-lg border border-[#BDBDBD] text-[#000000] bg-[#D9D9D9] font-semibold text-xs md:text-sm leading-[150%] tracking-[-0.02em]">
                        ...
                        <div v-if="selectedQuestion" class="w-full h-full overflow-y-auto">
                            ...
                            <div v-if="selectedQuestion.subpassage"
                                class="border border-2 w-full p-2 mb-2 text-xs md:text-sm leading-10 tracking-[-0.02em] text-left ">
                                보기
