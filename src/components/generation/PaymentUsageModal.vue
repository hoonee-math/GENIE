  ...
  <BaseModal :isOpen="isOpen" width="435px" height="600px" @close="closeModal">
    <div class="w-full h-full relative">
      <div class="flex flex-col gap-5 px-5 pt-[52px]">
        <p
          class="font-bold text-2xl leading-[150%] tracking-[-0.02em] text-[#303030]"
        >
          결제
        </p>
        <div
          class="flex flex-col w-full border border-[#0086ff] rounded-lg overflow-hidden"
        >
          <div
            class="flex justify-between items-center px-3 py-5 border-b border-[#0086ff]"
          >
            <div
              class="font-medium text-base leading-[150%] tracking-[-0.02em] text-[#303030]"
            >
              보유 이용권
            </div>
            <div
              class="font-semibold text-base leading-[150%] tracking-[-0.02em] text-[#303030]"
            >
              {{ creditcount }}회
            </div>
          </div>
      ...
      <p
        class="absolute left-5 top-[308px] font-normal text-sm leading-[150%] tracking-[-0.02em] text-[#e84739]"
      >
